...
function ChatBox(props: ChatBoxProps) {
    return(
        <div style={{ width: "100%", display: "flex", alignItems: "start", justifyContent: "start", gap: "12px", marginBottom: "10px" }}>
            ...
            <div style={{ backgroundColor: "#f6f3f4", borderRadius: "16px", padding: "12px 16px" }}>
                <p style={{ textAlign: "start", color: "black", fontSize: "16px", whiteSpace: "pre-wrap" }}>
                    {props.chatText}
                </p>
            </div>
